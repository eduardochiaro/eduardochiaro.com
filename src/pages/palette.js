        ...
        <section className={`px-4 lg:px-0 mt-10`}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-10 mt-10">
              { palette.map( color => (
              <div className="w-full rounded overflow-hidden drop-shadow">
                <div className={`w-full h-48 ${color.main} p-4 font-header text-2xl text-primary-100`}>
                  {color.name}
                </div>
                <div className="grid grid-cols-4">
                  { color.scale.map( shade => (
                    <div className={`h-10 ${shade}`}></div>
                  ))}
                </div>
              </div>
              ))}
            ...
            <div className="grid grid-cols-6 gap-10 mt-10">
              { secondaryPalette.map( color => (
                <div className={`w-12 h-12 ${color} m-auto rounded`}></div>
              ))}
            </div>
          </div>
        </section>
