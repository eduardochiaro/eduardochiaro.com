  ...
  return (
    <div className="flex flex-col h-screen justify-between">
      <div className="grow">
        ...
        <Jobs />
        <div className="relative"><span className="anchor" ref={skillsRef}/></div>
        <Skills />
        <hr className="mt-10 max-w-5xl mx-auto border-t border-solid border-primary-700 dark:border-primary-600" />
        <div className="relative"><span className="anchor" ref={articlesRef}/></div>
        <LatestPosts />
        <div className="relative"><span className="anchor" ref={githubRef}/></div>
        <GitHub />
      </div>
