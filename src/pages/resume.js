                      ...
                      <div className="pb-16 flex-1">
                        <div className="relative box-card p-4">
                          {job.logo && (
                            <SVG
                              alt={job.logo}
                              className={'absolute top-5 right-8 fill-primary-700 dark:fill-primary-200'}
                              src={`/uploads/${job.logo}`}
                              height={20}
                            />
                          )}
                          <h3 className="text-2xl font-header break-words mb-2">{job.name}</h3>
                          <h4 className="text-xl font-header break-words mb-2">{job.company}</h4>
                          <div className={'font-mono text-xs md:text-normal flex items-center gap-2 whitespace-nowrap'}>
                            {moment(job.startDate).format('MMMM YYYY')} <ChevronDoubleRightIcon className="h-5" />{' '}
                          ...
                          <>
                          <h5 className="mt-10 mb-2 text-lg">Projects</h5>
