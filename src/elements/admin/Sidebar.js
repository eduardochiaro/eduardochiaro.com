import { LogoutIcon, BriefcaseIcon } from "@heroicons/react/outline"
        ...
        <ul className="flex flex-col py-4 space-y-1">
          ...
          <li>
            <Link href="/admin/jobs">
              <a className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-terra-cotta-500 pr-6">
