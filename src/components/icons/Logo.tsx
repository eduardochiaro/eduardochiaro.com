...
const Logo: FunctionComponent<SVGProps> = ({ width = '1000', height = '1000', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 ${width} ${height}`} fill="currentColor" {...props}>
    <defs>
      ...
      <linearGradient
        gradientTransform="matrix(1 0 0 1 440.206 -439.974)"
        gradientUnits="userSpaceOnUse"
        id="LinearGradient_2"
        x1="131.236"
        x2="435.809"
    ...
    />
    <path
      d="M361.281 60.2188C319.736 60.2281 59.923 341.399 59.9375 360.031C59.9786 412.921 59.9702 729.699 59.9375 640.156C59.923 600.468 598.654 60.2281 641.094 60.2188C677.816 60.2106 431.022 60.203 361.281 60.2188ZM940.312 360.031L799.844 500.188L940.312 640.156L940.312 360.031ZM659.875 640.156C659.875 640.156 401.506 940.222 360.25 940.219C300.599 940.214 550.322 940.203 640.062 940.219C659.87 940.222 799.844 779.938 799.844 779.938L659.875 640.156Z"
      fill="currentColor"
      fillRule="nonzero"
      opacity="1"
      stroke="none"
