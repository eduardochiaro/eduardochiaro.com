  ...
  return (
    <section id="bio" className="px-4 lg:px-0 mt-8 md:mt-10">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mt-5 md:text-lg font-normal text-gray-600 dark:text-gray-200 md:leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nisl lacus, auctor condimentum mi vitae, bibendum pretium lacus. 
