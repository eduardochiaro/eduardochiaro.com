  ...
  return (
    <section id="bio" className="px-8 lg:px-0 mt-10">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mt-14 text-lg font-normal text-gray-600 dark:text-gray-200 leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nisl lacus, auctor condimentum mi vitae, bibendum pretium lacus. 
        ...
        <p className="mt-5 text-lg font-normal text-gray-600 dark:text-gray-200 leading-loose">Pellentesque tortor purus, ornare ac laoreet pellentesque, tincidunt non erat. Curabitur pellentesque velit nec mi rutrum, ac viverra nulla egestas. 
