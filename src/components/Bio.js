...
export default function Bio () {
  ...
  return (
    <section id="bio" className={`${styles.bio} px-0 sm:px-2 md:px-4`}>
      <div className="flex flex-row items-center justify-between container mx-auto">
        <div className="flex-1 basis-2/3 align-top mx-4 lg:mx-0">
          <h1 className="leading-tight text-3xl lg:text-5xl xl:text-7xl font-bold">
            I&apos;m <span className="text-terra-cotta-900">Eduardo</span>,
          </h1>
          <h2 className="leading-tight text-3xl lg:text-5xl xl:text-7xl font-bold">
